...
public class SamusCharacter : BaseCharacter 
{
	...
	public override void Awake () 
	{
		...
		soundClips = Resources.LoadAll <AudioClip> ("ZeroSuitSounds");
		base.Awake();
		//bool hasItem;
	}
	...
	public override void LeftRightA()
	{
		...
		AudioManager.instance.PlaySound(soundClips[12]);
	}
	...
	public override void SprintA()
	{
		...
		else
		{
			...
			AudioManager.instance.PlaySound(soundClips[15]);
	...
	public override void NeutralAAir()
	{
		...
		else
		{
			...
			AudioManager.instance.PlaySound(soundClips[20]);
	...
	public override void UpAir()
	{
		...
		else
		{
			...
			AudioManager.instance.PlaySound(soundClips[14]);
	...
	public override void DownAir()
	{
		...
		else
		{
			...
			AudioManager.instance.PlaySound(soundClips[1]);
	...
	public override void LeftRightSmashA()
	{
		...
		else
		{
			...
			AudioManager.instance.PlaySound(soundClips[17]);
